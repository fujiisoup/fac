...
\item[\texttt{float strength}:] In version 1.0.6 or older,
or multipole is 0 even in the newer version,
this is the weighted oscillator strength $gf$ of the transition.
The weighted radiative transition rate is related to $gf$ as (in atomic units):
\begin{equation}
...
In version 1.0.7 or newer, the stored value depends on
the multipole values used in \key{TransitionTable}.
...
#upper 2J  lower 2J  Delta E     gf            TR rate(1/s)  multipole
    ...
    32  2      0  0  8.9844E+02  2.652003E-01  3.096259E+12 -1.552313E-01
\end{verbatim}
Note that the TR rate is not weighted, i.e. it indicates Einstein's A
coefficient.
